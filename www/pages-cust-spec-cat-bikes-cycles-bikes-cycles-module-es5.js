...
var BikesCyclesPageModule = /** @class */ (function () {
    function BikesCyclesPageModule() {
    }
...
var BikesCyclesPage = /** @class */ (function () {
    function BikesCyclesPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, authService, loadingCtrl, alertService, router) {
    ...
    BikesCyclesPage.prototype.ngOnInit = function () {
    };
    BikesCyclesPage.prototype.ebike = function () {
        this.navCtrl.navigateForward('ebike');
    };
    BikesCyclesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-bikes-cycles-bikes-cycles-module-es5.js.map