...
var CustLoginPageModule = /** @class */ (function () {
    function CustLoginPageModule() {
    }
...
var CustLoginPage = /** @class */ (function () {
    function CustLoginPage(navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, authService, storage, alertService, router) {
    ...
    CustLoginPage.prototype.ionViewWillEnter = function () {
        this.menuCtrl.enable(false);
    };
    CustLoginPage.prototype.ngOnInit = function () {
    ...
    CustLoginPage.prototype.forgotPass = function () {
                                                ...
                                                case 1:
                                                    ...
                                                    loader.onWillDismiss().then(function (l) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                        ...
                                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                            ...
                                                            this.authService.sendCode(alertData.phone).subscribe(function (result) {
                                                                if (result['response']) {
                                                                    console.log(result);
    ...
    // // //
    CustLoginPage.prototype.goToRegister = function () {
        this.navCtrl.navigateRoot('cust-register');
    };
    CustLoginPage.prototype.resetPass = function () {
        this.navCtrl.navigateRoot('reset-password');
    };
    CustLoginPage.prototype.login = function () {
        var _this = this;
        // console.log(this.onLoginForm.value);
        this.authService.otpRequest(this.onLoginForm.value).subscribe(function (data) {
            console.log(data);
            if (data['status'] == true) {
                ...
                // })
                // this.navCtrl.navigateRoot('cust-home');
                var number = _this.onLoginForm.value;
    ...
    CustLoginPage.prototype.back = function () {
        this.navCtrl.navigateRoot('/');
    };
    CustLoginPage.prototype.callSupport = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CustLoginPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-cust-login-cust-login-module-es5.js.map