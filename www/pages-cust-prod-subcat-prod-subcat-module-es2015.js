...
let ProdSubcatPageModule = class ProdSubcatPageModule {
};
...
let ProdSubcatPage = class ProdSubcatPage {
    constructor(route, authService, alertService, loadingCtrl, alertCtrl, navCtrl, router, modalCtrl) {
        this.route = route;
...
//# sourceMappingURL=pages-cust-prod-subcat-prod-subcat-module-es2015.js.map