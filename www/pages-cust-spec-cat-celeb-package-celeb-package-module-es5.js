...
var CelebPackagePageModule = /** @class */ (function () {
    function CelebPackagePageModule() {
    }
...
var CelebPackagePage = /** @class */ (function () {
    function CelebPackagePage(navCtrl, router) {
    ...
    CelebPackagePage.prototype.ngOnInit = function () {
    };
    CelebPackagePage.prototype.goToItems = function (service) {
        console.log(service);
    ...
    CelebPackagePage.prototype.back = function () {
        this.navCtrl.navigateBack('celeb');
    };
    CelebPackagePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-celeb-package-celeb-package-module-es5.js.map