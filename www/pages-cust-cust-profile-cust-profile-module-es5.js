...
var CustProfilePageModule = /** @class */ (function () {
    function CustProfilePageModule() {
    }
...
var CustProfilePage = /** @class */ (function () {
    function CustProfilePage(navCtrl, loadingCtrl, toastCtrl, authService, alertService, alertCtrl, formBuilder, router) {
    ...
    CustProfilePage.prototype.ngOnInit = function () {
        this.getUser();
    };
    CustProfilePage.prototype.getUser = function () {
        var _this = this;
        this.authService.getUserProfile().subscribe(function (data) {
            console.log(data);
            _this.user = data.message;
            _this.image = data.image[0].image;
        });
    };
    CustProfilePage.prototype.editProfile = function () {
        this.navCtrl.navigateForward('edit-profile');
    };
    CustProfilePage.prototype.changePass = function () {
                                            ...
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    ...
                                                    loader.onWillDismiss().then(function (l) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                        ...
                                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                            console.log(data);
                                                            this.authService.changePass(data).subscribe(function (result) {
                                                                if (result['response']) {
                                                                    console.log(result);
    ...
    CustProfilePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-cust-profile-cust-profile-module-es5.js.map