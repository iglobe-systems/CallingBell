...
var CelebItemPageModule = /** @class */ (function () {
    function CelebItemPageModule() {
    }
...
var CelebItemPage = /** @class */ (function () {
    function CelebItemPage(navCtrl, router, route) {
    ...
    CelebItemPage.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.service = _this.router.getCurrentNavigation().extras.state.package;
                console.log(_this.service);
            }
        });
    };
    CelebItemPage.prototype.goToCardForm = function (card) {
    ...
    CelebItemPage.prototype.back = function () {
        this.navCtrl.navigateBack('celeb-package');
    };
    CelebItemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-celeb-item-celeb-item-module-es5.js.map