...
let CustRegisterPageModule = class CustRegisterPageModule {
};
...
let CustRegisterPage = class CustRegisterPage {
    constructor(navCtrl, menuCtrl, loadingCtrl, formBuilder, authService, alertService, router) {
    ...
    signUp() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.authService.register(this.onRegisterForm.value).subscribe(data => {
                console.log(data);
                if (data['status'] === true) {
                    console.log(this.onRegisterForm.value.phone);
                    this.authService.newRequest(this.onRegisterForm.value.phone).subscribe(result => {
                        console.log(result);
...
CustRegisterPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-cust-cust-register-cust-register-module-es2015.js.map