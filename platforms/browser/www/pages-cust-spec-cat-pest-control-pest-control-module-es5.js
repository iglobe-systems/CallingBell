...
var PestControlPageModule = /** @class */ (function () {
    function PestControlPageModule() {
    }
...
var PestControlPage = /** @class */ (function () {
    function PestControlPage(authService, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    PestControlPage.prototype.ngOnInit = function () {
    };
    PestControlPage.prototype.pestControl = function () {
        this.navCtrl.navigateForward('pest-control-second');
    };
    PestControlPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-pest-control-pest-control-module-es5.js.map