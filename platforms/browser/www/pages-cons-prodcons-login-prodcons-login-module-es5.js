...
var ProdconsLoginPageModule = /** @class */ (function () {
    function ProdconsLoginPageModule() {
    }
    ...
    return ProdconsLoginPageModule;
}());
...
var ProdconsLoginPage = /** @class */ (function () {
    function ProdconsLoginPage(navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, authService, storage, alertService) {
    ...
    ProdconsLoginPage.prototype.ionViewWillEnter = function () {
        this.menuCtrl.enable(false);
    };
    ProdconsLoginPage.prototype.ngOnInit = function () {
    ...
    ProdconsLoginPage.prototype.login = function () {
        var _this = this;
        console.log(this.onProdConsLoginForm.value);
        this.authService.consLogin(this.onProdConsLoginForm.value).subscribe(function (data) {
            console.log(data);
            if (data['response']) {
                ...
                _this.alertService.presentToast('Logged in successfully');
                _this.navCtrl.navigateRoot('cons-home', navigationExtras);
            }
            else {
    ...
    ProdconsLoginPage.prototype.back = function () {
        this.navCtrl.navigateBack('cons-start');
    };
    ProdconsLoginPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cons-prodcons-login-prodcons-login-module-es5.js.map