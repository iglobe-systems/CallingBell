...
var FamilyCardPageModule = /** @class */ (function () {
    function FamilyCardPageModule() {
    }
...
var FamilyCardPage = /** @class */ (function () {
    function FamilyCardPage(authService, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    FamilyCardPage.prototype.ngOnInit = function () {
    };
    FamilyCardPage.prototype.back = function () {
        this.navCtrl.navigateBack('cust-home');
    };
    FamilyCardPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-family-card-family-card-module-es5.js.map