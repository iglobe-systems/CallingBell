...
var ProdLatestArrivalsPageModule = /** @class */ (function () {
    function ProdLatestArrivalsPageModule() {
    }
    ...
    return ProdLatestArrivalsPageModule;
}());
...
var ProdLatestArrivalsPage = /** @class */ (function () {
    function ProdLatestArrivalsPage(route, authService, alertService, loadingCtrl, alertCtrl, navCtrl, router, cartService) {
        this.route = route;
    ...
    ProdLatestArrivalsPage.prototype.ngOnInit = function () {
        this.getProducts();
    };
    ProdLatestArrivalsPage.prototype.getProducts = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.prodcat = _this.router.getCurrentNavigation().extras.state.prodcat;
                _this.subcat = _this.router.getCurrentNavigation().extras.state.subCat.subcategory;
                console.log(_this.prodcat);
                console.log(_this.subcat);
                _this.authService.getLatestArrival(_this.prodcat, _this.subcat).subscribe(function (result) {
                    console.log(result);
    ...
    ProdLatestArrivalsPage.prototype.getProductDesc = function (prod) {
    ...
    ProdLatestArrivalsPage.prototype.opencart = function () {
        this.navCtrl.navigateForward('cart');
    };
    ProdLatestArrivalsPage.prototype.back = function () {
        this.navCtrl.navigateBack('prod-subcat');
    };
    ProdLatestArrivalsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-prod-latest-arrivals-prod-latest-arrivals-module-es5.js.map