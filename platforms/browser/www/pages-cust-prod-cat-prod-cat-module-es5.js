...
var ProdCatPageModule = /** @class */ (function () {
    function ProdCatPageModule() {
    }
...
var ProdCatPage = /** @class */ (function () {
    function ProdCatPage(authService, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    ProdCatPage.prototype.ngOnInit = function () {
        this.productCategory();
    };
    ProdCatPage.prototype.productCategory = function () {
        var _this = this;
        this.authService.getProducts().subscribe(function (data) {
            console.log(data);
            _this.prodCat = data.message;
        });
    };
    ProdCatPage.prototype.productList = function (p) {
    ...
    ProdCatPage.prototype.notifications = function (ev, p) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var popover;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ProdCatPage.prototype.openSupport = function (p) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProdCatPage.prototype.opencart = function () {
        this.navCtrl.navigateForward('cart');
    };
    ProdCatPage.prototype.back = function () {
        this.navCtrl.navigateBack('cust-home');
    };
    ProdCatPage.prototype.otherService = function () {
        this.navCtrl.navigateForward('other-services');
    };
    ProdCatPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-prod-cat-prod-cat-module-es5.js.map