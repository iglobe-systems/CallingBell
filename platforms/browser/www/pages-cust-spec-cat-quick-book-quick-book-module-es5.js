...
var QuickBookPageModule = /** @class */ (function () {
    function QuickBookPageModule() {
    }
...
var QuickBookPage = /** @class */ (function () {
    function QuickBookPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, authService, loadingCtrl, alertService, router, route) {
    ...
    QuickBookPage.prototype.ngOnInit = function () {
        this.allService();
    };
    QuickBookPage.prototype.allService = function () {
        var _this = this;
    ...
    QuickBookPage.prototype.back = function () {
        this.navCtrl.navigateBack('trending-issues');
    };
    QuickBookPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-quick-book-quick-book-module-es5.js.map