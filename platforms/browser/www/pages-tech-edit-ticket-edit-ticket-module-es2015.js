...
let EditTicketPageModule = class EditTicketPageModule {
};
...
let EditTicketPage = class EditTicketPage {
    constructor(route, authService, alertService, loadingCtrl, alertCtrl, navCtrl, formBuilder, router) {
        this.route = route;
    ...
    updateTicket(id, number) {
        ...
        this.authService.updateTicket(id, number, this.onUpdateForm.value).subscribe(data => {
            console.log(data);
            if (data['response']) {
...
//# sourceMappingURL=pages-tech-edit-ticket-edit-ticket-module-es2015.js.map