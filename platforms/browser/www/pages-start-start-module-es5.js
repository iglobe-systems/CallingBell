...
var StartPage = /** @class */ (function () {
    function StartPage(navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, authService, storage, alertService) {
    ...
    StartPage.prototype.custLogin = function () {
    ...
    StartPage.prototype.techLogin = function () {
        this.navCtrl.navigateRoot('tech-login');
    };
    StartPage.prototype.consLogin = function () {
        this.navCtrl.navigateRoot('cons-start');
    };
    // career(){
    //   this.navCtrl.navigateForward('slides');
    // }
    StartPage.prototype.corp = function (message) {
