...
var ClosedTicketsPageModule = /** @class */ (function () {
    function ClosedTicketsPageModule() {
    }
    ...
    return ClosedTicketsPageModule;
}());
...
var ClosedTicketsPage = /** @class */ (function () {
    function ClosedTicketsPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, authService, loadingCtrl, alertService, router) {
    ...
    ClosedTicketsPage.prototype.ngOnInit = function () {
        this.getTickets();
    };
    ClosedTicketsPage.prototype.getTickets = function () {
        var _this = this;
        var body = '';
        this.authService.closedTickets(body).subscribe(function (data) {
            console.log(data);
            _this.ticket = data['message'];
        });
    };
    ClosedTicketsPage.prototype.viewTicket = function (t) {
    ...
    ClosedTicketsPage.prototype.logout = function () {
        this.authService.techlogout();
        this.navCtrl.navigateRoot('/');
    };
    ClosedTicketsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-tech-closed-tickets-closed-tickets-module-es5.js.map