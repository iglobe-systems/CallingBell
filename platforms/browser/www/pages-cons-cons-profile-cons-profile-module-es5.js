...
var ConsProfilePageModule = /** @class */ (function () {
    function ConsProfilePageModule() {
    }
...
var ConsProfilePage = /** @class */ (function () {
    function ConsProfilePage(navCtrl, loadingCtrl, toastCtrl, authService, alertService, alertCtrl, router) {
    ...
    ConsProfilePage.prototype.ngOnInit = function () {
        this.profile();
    };
    ConsProfilePage.prototype.profile = function () {
        var _this = this;
        this.authService.consProfile().subscribe(function (data) {
            console.log(data);
            _this.user = data['message'];
            console.log(_this.user);
        });
    };
    ConsProfilePage.prototype.changePass = function () {
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                        ...
                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    if (!(data.newpass == data.confirmnewpass)) return [3 /*break*/, 2];
                                                ...
                                                case 1:
                                                    ...
                                                    loader.onWillDismiss().then(function (l) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                        ...
                                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                            console.log(data);
                                                            this.authService.consChangePass(data).subscribe(function (result) {
                                                                if (result['response']) {
                                                                    console.log(result);
    ...
    ConsProfilePage.prototype.logout = function () {
        this.authService.logout();
        this.navCtrl.navigateRoot('/');
    };
    ConsProfilePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cons-cons-profile-cons-profile-module-es5.js.map