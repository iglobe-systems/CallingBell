...
var ServiceDescPageModule = /** @class */ (function () {
    function ServiceDescPageModule() {
    }
...
var ServiceDescPage = /** @class */ (function () {
    function ServiceDescPage(authService, route, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    ServiceDescPage.prototype.ngOnInit = function () {
        this.serviceStatus();
    };
    ServiceDescPage.prototype.serviceStatus = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.id = _this.router.getCurrentNavigation().extras.state.status.id;
                _this.authService.serviceDesc(_this.id).subscribe(function (data) {
                    console.log(data);
                    _this.status = data.message;
                    if (data.response == true) {
                        _this.alertService.presentToast('Ticket Details');
                    }
                    else {
    ...
    ServiceDescPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-service-desc-service-desc-module-es5.js.map