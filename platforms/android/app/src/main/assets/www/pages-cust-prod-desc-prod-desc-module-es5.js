...
var ProdDescPage = /** @class */ (function () {
    function ProdDescPage(route, authService, alertService, loadingCtrl, alertCtrl, navCtrl, router, cartService, modalCtrl) {
        this.route = route;
    ...
    ProdDescPage.prototype.getProducts = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.product = _this.router.getCurrentNavigation().extras.state.prod.productId;
                // this.brand = this.router.getCurrentNavigation().extras.state.brand.brand;
                console.log(_this.product);
                //console.log(this.brand);
                _this.authService.getProductDesc(_this.product).subscribe(function (result) {
                    console.log(result);
                    _this.productDetail = result['message'];
                    _this.images = result['image'];
