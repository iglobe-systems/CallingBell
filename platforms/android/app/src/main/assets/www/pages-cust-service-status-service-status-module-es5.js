...
var ServiceStatusPageModule = /** @class */ (function () {
    function ServiceStatusPageModule() {
    }
    ...
    return ServiceStatusPageModule;
}());
...
var ServiceStatusPage = /** @class */ (function () {
    function ServiceStatusPage(authService, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    ServiceStatusPage.prototype.ngOnInit = function () {
        this.serviceStatus();
    };
    ServiceStatusPage.prototype.serviceStatus = function () {
        var _this = this;
        this.authService.serviceStatus().subscribe(function (data) {
            console.log(data);
            _this.status = data.message;
            if (data.response == true) {
                _this.alertService.presentToast('You have the following support request');
            }
            else {
    ...
    ServiceStatusPage.prototype.serviceDesc = function (s) {
    ...
    ServiceStatusPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-service-status-service-status-module-es5.js.map