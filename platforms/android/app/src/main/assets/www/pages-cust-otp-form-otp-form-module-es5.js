...
var OtpFormPageModule = /** @class */ (function () {
    function OtpFormPageModule() {
    }
...
var OtpFormPage = /** @class */ (function () {
    function OtpFormPage(navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, authService, storage, alertService, router, route) {
    ...
    OtpFormPage.prototype.ngOnInit = function () {
        this.getNumber();
    ...
    OtpFormPage.prototype.getNumber = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.number = _this.router.getCurrentNavigation().extras.state.number;
                console.log(_this.number);
            }
        });
    };
    OtpFormPage.prototype.verifyOtp = function () {
        var _this = this;
        var phone = this.number.phone;
        var otp = this.onOtpForm.value.otp;
        this.authService.verifyOtp(phone, otp).subscribe(function (result) {
            if (result['status'] == true) {
                console.log(result);
                console.log(result['data'].api_key);
                _this.storage.setItem('user', {
    ...
    OtpFormPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-otp-form-otp-form-module-es5.js.map