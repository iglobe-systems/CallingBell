...
var DocsPage = /** @class */ (function () {
    function DocsPage(authService, alertService, loadingCtrl, alertCtrl, navCtrl, popoverCtrl, router) {
    ...
    DocsPage.prototype.ngOnInit = function () {
    };
    DocsPage.prototype.back = function () {
        this.navCtrl.navigateBack('cust-home');
    };
    DocsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-docs-docs-module-es5.js.map