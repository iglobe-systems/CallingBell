...
var IssueListPageModule = /** @class */ (function () {
    function IssueListPageModule() {
    }
...
var IssueListPage = /** @class */ (function () {
    function IssueListPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, authService, loadingCtrl, alertService, router, route) {
    ...
    IssueListPage.prototype.ngOnInit = function () {
        this.getIssueList();
    };
    IssueListPage.prototype.getIssueList = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.issue = _this.router.getCurrentNavigation().extras.state.service.id;
                _this.subCategory = _this.router.getCurrentNavigation().extras.state.service.name;
                _this.authService.getServiceCategory(_this.issue).subscribe(function (result) {
                    console.log(result);
                    _this.issueList = result['data'].list;
                    console.log(_this.issueList);
                });
            }
        });
    };
    IssueListPage.prototype.opencart = function () {
    ...
    IssueListPage.prototype.back = function () {
        this.navCtrl.navigateBack('trending-issues');
    };
    IssueListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-spec-cat-issue-list-issue-list-module-es5.js.map