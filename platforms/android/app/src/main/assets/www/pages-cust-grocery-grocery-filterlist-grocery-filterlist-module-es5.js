...
var GroceryFilterlistPageModule = /** @class */ (function () {
    function GroceryFilterlistPageModule() {
    }
    ...
    return GroceryFilterlistPageModule;
}());
...
var GroceryFilterlistPage = /** @class */ (function () {
    ...
    GroceryFilterlistPage.prototype.getFilteredList = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                _this.groceryList = _this.router.getCurrentNavigation().extras.state.groceryList;
                _this.groceryBrand = _this.router.getCurrentNavigation().extras.state.groceryFilter.brandname;
                _this.groceryQty = _this.router.getCurrentNavigation().extras.state.groceryFilter.quantity;
                console.log(_this.groceryBrand, _this.groceryQty);
            }
        });
    };
    GroceryFilterlistPage.prototype.grocerydesc = function (desc) {
    ...
    GroceryFilterlistPage.prototype.back = function () {
        this.navCtrl.navigateBack('grocery-filter');
    };
    GroceryFilterlistPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-cust-grocery-grocery-filterlist-grocery-filterlist-module-es5.js.map